...
export const AllProject = [
  {
    ...
    demo: 'https://github.com/FSCodersHub/FScodersHub-Community',
...
,
  ...
  link: "https://aymanecloclo.github.io/IA_tech/#",
  demo: "https://aymanecloclo.github.io/IA_tech/#",  
  ecs: ["HTML5", "CSS3", "Bootstrap"],
},  {
  id: 6,
  src: tic,  // Vérifie le chemin de l'image (si tu veux l'afficher)
  title: {
    en: "Tic-Tac-Toe",
    fr: "Tic-Tac-Toe",
  },
  content: {
    en: "A simple and interactive Tic-Tac-Toe game built with React and styled using Tailwind CSS.",
    fr: "Un jeu Tic-Tac-Toe simple et interactif construit avec React et stylisé avec Tailwind CSS.",
  },
  link: "https://aymanecloclo.github.io/Tic-Tac-Toe/",  // Vérifie que le lien est correct
  ecs: ["React", "Tailwind", "UX/UI"],
}
