  ...
  return (
    <div id="hire" className={`${hire?'absolute':'hidden'}  w-full h-screen flex items-center justify-center z-50 top-10`}>
      ...
      >
        ...
        {/* Subject Input */}
        <FormInput2
          inputLabel={language=='en'?"subject":'object'}
          labelFor="subject"
          inputType="text"
          inputId="subject"
          inputName="subject"
          placeholderText={language=='en'?"subject":'object'}
        ...
        <div className="mt-6">
          ...
          <textarea
            ...
            rows="6"
            aria-label="Message"
            placeholder={language=='fr'?"Taper votre message ici...":"Type your message here..." }
        ...
        <div className="mt-6">
          ...
          >
             {language=='fr'?"Envoyer message":'Send Message'}
          </button>
        </div>
      </form>
    </div>
